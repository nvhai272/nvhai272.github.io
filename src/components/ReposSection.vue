      ...
      >
        ...
        <div class="flex items-center gap-4 text-xs text-slate-400 dark:text-slate-500">
          ...
          <span class="flex items-center gap-1">
            <Star class="size-3" />{{ repo.stargazers_count }}
          </span>
          <span class="flex items-center gap-1">
            <GitFork class="size-3" />{{ repo.forks_count }}
          </span>
        </div>
      </a>
    </div>
...
import { FolderGit2, BookMarked, Star, GitFork, AlertCircle, ExternalLink } from 'lucide-vue-next'
